...
output1 = 'test_videos_output/testRES.mp4'
output2 = 'test_videos_output/test2RES.mp4'
output3 = 'test_videos_output/test3RES.mp4'


clip1 = VideoFileClip("vids/test.mp4")#.subclip(3,5)
clip2 = VideoFileClip("vids/test2.mp4")#.subclip(3,5)
clip3 = VideoFileClip("vids/test3.mov")#.subclip(3,5)
...
# lol i needed to make this a 200 line project
# haha line #200